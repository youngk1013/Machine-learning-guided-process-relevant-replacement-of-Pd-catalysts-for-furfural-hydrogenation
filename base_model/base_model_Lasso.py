...
#%% Save model
with open(f"./base_model/output/Lasso_model_seed{SEED}.pkl", "wb") as f:
    pickle.dump(model, f)

#%% Load model
with open(f"./base_model/output/Lasso_model_seed{SEED}.pkl", "rb") as f:
