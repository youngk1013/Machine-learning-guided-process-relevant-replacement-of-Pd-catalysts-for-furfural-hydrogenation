...
#%% K-fold validation
set_seed(SEED)
params = base_params['RandomForest']
...
#%% Save model
with open(f"./base_model/output/RF_model_seed{SEED}.pkl", "wb") as f:
    pickle.dump(model, f)

#%% Load model
with open(f"/base_model/output/Rf_model_seed{SEED}.pkl", "rb") as f:
