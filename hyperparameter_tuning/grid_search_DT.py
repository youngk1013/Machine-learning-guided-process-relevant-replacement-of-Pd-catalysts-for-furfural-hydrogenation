...
for depth in param_grid["max_depth"]:
    for leaf in param_grid["min_samples_leaf"]:
        for split in param_grid["min_samples_split"]:
            ...
            print(
                f"depth={str(depth):<4} leaf={leaf:<2} split={split:<2} | "
...
with open(f'./hyperparameter_tuning/output/DT_model_seed{SEED}.pkl', "wb") as f:
    pickle.dump(model, f)

with open(f'./hyperparameter_tuning/output/DT_model_params_seed{SEED}.pkl', "wb") as f:
    pickle.dump(best_params, f)

#%% Reproduce model
SEED = 23

with open(f'./hyperparameter_tuning/output/DT_model_params_seed{SEED}.pkl', "rb") as f:
    loaded_best_params = pickle.load(f)

print(loaded_best_params)

with open(f'./hyperparameter_tuning/output/DT_model_seed{SEED}.pkl', "rb") as f:
    model = pickle.load(f)
